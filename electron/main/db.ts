...
type InsertDto<T extends keyof typeof import('../../db/schema')> = Omit<typeof import('../../db/schema')[T]['$inferInsert'], 'id' | 'created_at' | 'updated_at' | 'deleted_at' | 'dirty'>;
type UpdateDto<T extends keyof typeof import('../../db/schema')> = Omit<typeof import('../../db/schema')[T]['$inferInsert'], 'id' | 'created_at' | 'updated_at' | 'deleted_at' | 'dirty'>;
