...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-[#1a4fd6] flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background decorative blobs */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        <div className="absolute top-[-15%] right-[-5%] w-[45%] h-[45%] bg-[#1440b8] rounded-full blur-[100px] opacity-60"></div>
        <div className="absolute bottom-[-10%] left-[-5%] w-[40%] h-[40%] bg-[#f97316] rounded-full blur-[130px] opacity-20"></div>
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center bg-[#f97316] p-4 rounded-3xl mb-6 shadow-2xl shadow-orange-600/40">
        ...
        <form onSubmit={handleLogin} className="bg-white/10 backdrop-blur-sm border border-white/15 p-8 rounded-[2rem] space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#1440b8]/60 border border-white/15 rounded-xl py-3.5 pl-11 pr-4 text-white placeholder-blue-300/50 focus:outline-none focus:ring-2 focus:ring-[#f97316]/70 focus:border-transparent transition-all"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#f97316] hover:bg-[#fb923c] text-white font-black py-4 rounded-xl uppercase tracking-widest flex items-center justify-center gap-3 transition-all shadow-xl shadow-orange-600/30 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
