...
export const Billing: React.FC<BillingProps> = ({ customers, vehicles }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-900">Cobranças & Automação</h2>
        <p className="text-slate-500">Gestão de pagamentos pendentes e disparos via WhatsApp API (Simulado).</p>
      </div>
