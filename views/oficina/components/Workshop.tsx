...
export const Workshop: React.FC<WorkshopProps> = ({
  ...
  return (
    <div className="space-y-8">
      ...
      {showForm && (
        <div className="fixed inset-0 bg-[#004AAD]/80 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
          <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in duration-300">
            <div className="bg-[#004AAD] p-8 flex justify-between items-center text-white">
            ...
            <form onSubmit={handleSubmit} className="p-10 space-y-6">
              ...
              <div className="pt-4 flex gap-4">
                ...
                <button
                  type="submit"
                  className="flex-1 py-4 bg-[#004AAD] text-white rounded-xl font-black uppercase tracking-widest shadow-lg shadow-blue-100 transition-all"
                >
                  Registrar
                </button>
              </div>
